...
- [ ] **Observation sensitivity dashboard** — Wrap `analyze_observation_sensitivity.py` into a CLI that reads the latest log and prints a ranked feature importance table automatically.
